...
@TableName("tb_letter_sms_record")
@ApiModel(value="LetterSmsRecord对象", description="积分表")
public class LetterSmsRecord extends Model<LetterSmsRecord> {
